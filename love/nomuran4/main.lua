...
rect2 = Rectangle:new(30,30,530,180)
table.insert(entities, rect)
table.insert(entities, rect2)
...
function love.update(dt)
    ...
    if rect.xPos < rect2.xPos then rect2:accLeft()
    end
    if rect.xPos > rect2.xPos then rect2:accRight()
    end
    if rect.yPos < rect2.yPos then rect2.ySpeed = -2
    end
    if rect.yPos > rect2.yPos then rect2.ySpeed = 2
	end
