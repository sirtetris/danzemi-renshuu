...
function Teki:new(w, h, xPos, yPos)
    local o = {}
...
function Teki:draw()
    love.graphics.setColor(255, 255, 255)
 	love.graphics.circle("fill", self.xPos, self.yPos, 10, 100)    
end
...
rect3 = Teki:new(700,50,10,10)
circ = Teki:new(700,50,40,40)
...
function love.draw()
    ...
    love.graphics.print("th: " .. #tekihairetsu, 220, 40)
    for i, e in ipairs(entities) do
        e:draw()
    end
    circ:draw()
    rect3:draw()
    for i,teki in ipairs(tekihairetsu)do
    	teki:draw()
    end
...
if rect3.yPos - rect.yPos <=0 then

  rect3.yPos = rect3.yPos + 0.5
else
...
if rect3.xPos - rect.xPos <=0 then

  rect3.xPos = rect3.xPos + 0.5
  ...
  rect3.xPos = rect3.xPos - 0.5
    ...
    for i,teki in ipairs(tekihairetsu)do
if teki.yPos - rect.yPos <=0 then

  teki.yPos = teki.yPos + 0.5
else
...
if teki.xPos - rect.xPos <=0 then

  teki.xPos = teki.xPos + 0.5
  ...
  teki.xPos = teki.xPos - 0.5
    ...
    table.insert(tekihairetsu, Teki:new(700,50,10,10))
