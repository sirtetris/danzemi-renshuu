...
function Enemy:tick(dt)
    MovingThing.tick(self, dt) -- :tick(dt) doesn't work. because reasons
	if player.holding == nil then return
    end
	if player.xPos < self.xPos then self:accLeft()
    end
    if player.xPos > self.xPos then self:accRight()
    end
    if player.yPos < self.yPos then self:jump()
    end
end
...
plattform1 = Block:new(30, 480, 80, 5, {100, 200, 100})
plattform2 = Block:new(140, 380, 110, 5, {100, 100, 200})
plattform3 = Block:new(400, 360, 90, 5, {200, 100, 100})
...
plattform7 = Block:new(470,150,100,5,{40,50,60})
plattform8 = Block:new(180,550,40,5,{30,20,10})
plattform9 = Block:new(500,550,50,5,{59,90,90})
...
table.insert(entities, plattform8)
table.insert(entities, plattform9)
